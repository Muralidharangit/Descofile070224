...
<div class="main-content">
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        ...
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">List Gallery</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('gallery.edit', $item->id) }}"><i
                                                    data-feather="edit"></i></a>

                                            <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal"
                                                data-bs-target="#deleteModal"><i data-feather="trash"></i></button>
                                            <!-- Modal -->
                                                ...
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body text-center">
                                                            <h2 class="mb-4"><i class="fa-solid fa-circle-exclamation"
                                                                    style="color: #e1b514; font-size:65px"></i></h2>
                                                            <h4>Are you sure?</h6>
                                                                <h5 class="mt-3">You won't be able to revert this!</h5>
                                                        </div>
                                                        <div class="modal-footer mx-auto">

                                                            <form
                                                                action="{{ route('gallery.delete', ['id' => $item->id]) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
    ...
    <script>
    // Add a JavaScript timeout to automatically hide the success alert after 3 seconds
    setTimeout(function() {
