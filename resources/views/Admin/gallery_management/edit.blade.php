                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Edit Galleries</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Edit Gallery</h4>
                            ...
                            <form action="{{ route('gallery.update', $gallery->id) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <p>Image</p>
                                            <img src="{{ asset('storage/' . $gallery->image) }}" alt="Image Preview"
