                    ...
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Create Galleries</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xxl-6">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Create Gallery</h4>
                            <a href="{{route('gallery.list')}}">Back</a>
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('gallery.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <br>
                                <div>
                                    <label>Gallery Image <span class="text-danger">*(Below 20 Mb)</span></label>
