...
<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Oct 2023 05:35:41 GMT -->
<head>
    ...
    <!-- Layout config Js -->
    <script src="{{ asset('admin/aassets/js/layout.js')}}"></script>
    <!-- Bootstrap Css -->
  ...
  <link href="{{ asset('admin/assets/libs/sweetalert2/sweetalert2.min.css')}}" rel="stylesheet" type="text/css" />
     ...
     <link href="{{ asset('admin/assets/datatables/jquery.dataTables.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/assets/datatables/responsive.bootstrap.min.css') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('admin/assets/datatables/dataTables.bootstrap.min.css') }}" rel="stylesheet"
        type="text/css" />
                ...
                <div class="dropdown ms-sm-3 header-item topbar-user">
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- https://cdn-icons-png.flaticon.com/512/3135/3135715.png -->
                            <img class="rounded-circle header-profile-user" src="{{ asset('admin/assets/images/users/profile-img.png')}}" alt="Header Avatar">
...
<div id="removeNotificationModal" class="modal fade zoomIn" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        ...
        <div class="app-menu navbar-menu">
            <!-- LOGO -->
            <div class="navbar-brand-box"  style="    text-align: left;">
                <!-- Dark Logo-->
                <a href="index.html" class="logo logo-dark">
                    <!-- <h4>Desco</h4> -->
                    <span class="logo-sm">
                ...
                <!-- Light Logo-->
                <a href="index.html" class="logo logo-light">
                <h5 class="text-white mt-3 mx-2">Desco</h5>
                    <!-- <span class="logo-sm">
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <li class="nav-item">
                            ...
                            <i class="ri-home-4-line"></i> <span data-key="t-widgets"> Go to Website</span>
                            </a>
                        </li>
                            ...
                            <i class="ri-dashboard-line"></i> <span data-key="t-widgets1">Dashboard</span>
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarDashboards">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="{{route('user.list')}}" class="nav-link" data-key="t-analytics"> All Users </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            ...
                            <i class="ri-gallery-fill"></i> <span data-key="t-authentication">Gallery Management</span>
                            </a>
                            <div class="collapse menu-dropdown" id="sidebarAuth">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <!-- <a href="{{route('gallery.list')}}" class="nav-link" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarSignIn" data-key="t-signin"> All Gallery
                                        </a> -->
                                        <a href="{{route('gallery.list')}}" class="nav-link" data-key="t-analytics"> All Gallery </a>
                                    </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link" href="#sidebarUI" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarUI">
                                <i class=" ri-contacts-book-line"></i> <span data-key="t-base-ui">contact Management</span>
                            </a>
                            <div class="collapse menu-dropdown mega-dropdown-menu" id="sidebarUI">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <ul class="nav nav-sm flex-column">
                                            <li class="nav-item">
                                                <a href="{{route('contact.list')}}" class="nav-link" data-key="t-alerts">All Contact</a>
                                            </li>
...
<script src="{{ asset('admin/assets/js/pages/sweetalerts.init.js')}}"></script>
    ...
    <script src="{{ asset('admin/assets/datatables/responsive.bootstrap.min.js') }}"></script>
</body>


<!-- Mirrored from themesbrand.com/velzon/html/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 18 Oct 2023 05:36:41 GMT -->
</html>